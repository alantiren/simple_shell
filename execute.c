...
/**
 * _exect - function to find and execute the requested program.
 * @argu: where find the program arguments to execute.
 ...
 */
int _exect(char **argu, char **throgh, int s0, int s1, int *wstat)
{
